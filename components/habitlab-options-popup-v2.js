(function(){
  var polymer_ext, swal, load_css_file, ref$, set_intervention_disabled, set_intervention_disabled_permanently, disable_habitlab, open_url_in_new_tab, get_goals, add_log_habitlab_disabled, intervention;
  ...
  add_log_habitlab_disabled = require('libs_common/log_utils').add_log_habitlab_disabled;
  ...
  polymer_ext({
    ...
    disable_habitlab_callback: function(){
      ...
      return add_log_habitlab_disabled({
        ...
        loaded_intervention: intervention != null ? intervention.name : void 8,
        loaded_interventions: [intervention != null ? intervention.name : void 8],
