(function(){
  ...
  ref$ = require('libs_backend/log_utils'), add_log_feedback = ref$.add_log_feedback, add_log_habitlab_disabled = ref$.add_log_habitlab_disabled, add_log_habitlab_enabled = ref$.add_log_habitlab_enabled;
  swal_cached = null;
